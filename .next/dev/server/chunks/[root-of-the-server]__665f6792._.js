...
"[project]/app/api/chat/fitbit/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function summarizeSleepByDate(entries) {
    const map = {};
...
function walk(dir, out = []) {
    for (const entry of __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readdirSync(dir, {
        withFileTypes: true
    })){
...
async function GET() {
    try {
        ...
        const root = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "data", "Fitbit");
        // Debug: confirm what folder we are scanning
        if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(root)) {
        ...
        const sleepFiles = allFiles.filter((fp)=>{
            const name = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(fp).toLowerCase();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__665f6792._.js.map